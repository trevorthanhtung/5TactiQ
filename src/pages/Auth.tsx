      ...
      <div className="w-full max-w-md animate-fade-in-up relative z-10">
        ...
        <div className="hallmark-card p-6 sm:p-8 mb-6 bg-surface border-2 border-border-main shadow-xl relative overflow-hidden">
          ...
          <button
            ...
            className="w-full flex items-center justify-center py-3 bg-surface-2 border-2 border-border-main text-text-main hover:border-primary hover:bg-surface transition-all font-display uppercase tracking-wider text-xs font-bold gap-3 shadow-sm active:scale-[0.99]"
          >
