...
export function MatchdayDetailSkeleton() {
  return (
    <div className="p-4 md:p-6 flex flex-col min-h-full max-w-5xl mx-auto w-full gap-6 animate-pulse">
      ...
      {/* 2. Match Banner Card */}
      <div className="bg-surface-2 border-2 border-border-main p-6 md:p-8 flex flex-col items-center relative overflow-hidden shadow-xl shrink-0">
        <div className="h-3 w-32 bg-text-muted/20 rounded mb-4"></div>
      ...
      <div className="flex-1 flex flex-col">
        {/* Tab */}
        <div className="w-full bg-text-muted/20 h-12 mb-6 rounded-sm"></div>
        ...
        <div className="flex flex-col flex-1 bg-surface border-2 border-border-main mb-6">
          {[1, 2, 3, 4, 5].map((i) => (
            <div key={i} className="flex items-center p-3 md:p-4 border-b-2 border-border-main">
