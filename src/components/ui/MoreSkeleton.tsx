...
export function MoreSkeleton() {
  return (
    <div className="p-4 max-w-5xl mx-auto pb-8 w-full animate-pulse">
      {/* Header Skeleton */}
      <div className="h-10 w-32 bg-slate-300 rounded mb-6 pt-2"></div>
      ...
      <div className="mb-8">
        ...
        <div className="space-y-3">
          {[1, 2, 3].map((i) => (
            <div key={i} className="hallmark-card bg-surface p-4 flex items-center justify-between border-2 border-transparent">
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 bg-slate-300 rounded-full shrink-0"></div>
                <div>
                  <div className="h-5 w-48 bg-slate-300 rounded mb-1"></div>
      ...
      {/* Section 2 Skeleton */}
      <div className="mb-8">
        <div className="h-4 w-40 bg-slate-300 rounded mb-4"></div>
        <div className="space-y-3">
          {[1, 2, 3].map((i) => (
            <div key={i} className="hallmark-card bg-surface p-4 flex items-center justify-between border-2 border-transparent">
              <div className="flex items-center gap-4">
