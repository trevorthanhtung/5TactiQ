...
export default function Layout() {
  ...
  return (
    <div className="flex flex-col lg:flex-row h-screen bg-surface overflow-hidden font-sans">
      ...
      <nav className="hidden lg:flex flex-col w-24 bg-surface border-r-2 border-border-main shrink-0 z-40">
      ...
      <main id="main-content" className="flex-1 overflow-hidden lg:pb-0 @container bg-accent/30 relative">
        <AnimatePresence mode="wait">
          <PageWrapper key={location.pathname} className="absolute inset-0 overflow-y-auto pb-[calc(6rem+env(safe-area-inset-bottom))] lg:pb-0">
            {outlet}
          </PageWrapper>
        </AnimatePresence>
      </main>
